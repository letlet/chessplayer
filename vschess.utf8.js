...
(function(window,undefined){var ZeroClipboard={version:"1.0.7",clients:{},moviePath:'/static/vschess/copy.swf',nextId:0,$:function(thingy){if(typeof(thingy)=='string'){thingy=document.getElementById(thingy);}
...
else if(typeof(func)=='string'){window[func](this,args);}}}}};if(typeof window.ZeroClipboard=="undefined"){window.ZeroClipboard=ZeroClipboard;}})(window);(function($,window){Array.prototype.clone=function(){return this.slice(0);};var IE=false,IE6=false,IE7=false,IE8=false,IE9=false,IE10=false,IEother=false,WebKit=false,Opera=false,FireFox=false,Other=false;(function(){if($.browser.msie){IE=true;if($.browser.version=="6.0"){IE6=true;}
else if($.browser.version=="7.0"){IE7=true;}
else if($.browser.version=="8.0"){IE8=true;}
else if($.browser.version=="9.0"){IE9=true;}
else if($.browser.version=="10.0"){IE10=true;}
else{IEother=true;}}
else if($.browser.safari){WebKit=true;}
else if($.browser.opera){Opera=true;}
else if($.browser.mozilla){FireFox=true;}
else{Other=true;}})();var document=window.document,vschess={version:"V1.1.6",chessid:0,copycontent:0,iframe:0,turl:"",savepgncopy:new ZeroClipboard.Client(),server:"vschess/vschess.php?",picpath:"vschess/chinese/",chessmanstyle:"normal",soundpath:"vschess/sounds/",play:new Array(),time:new Array(),step:new Array(),time_each:new Array(),result:new Array(),automove:new Array(),sound:new Array(),tips:new Array(),turn:new Array(),move:new Array(),clip:new Array(),format:new Array(),usermove:new Array(),oldcontent:new Array(),setsteps:new Array(),pfchess:new Array(),pf2str:new Array(),pfreload:new Array(),senddom:new Array(),livepause:new Array(),saveqq:new Array(),saveqqm:new Array(),currentfen:new Array(),beginfen:new Array(),putchessman:new Array(),situation:new Array(),comments:new Array(),resetdom:new Array(),controlbar:new Array(),eachstep:new Array(),animate:new Array(),moveindex:new Array(),checkmove:new Array(),eachposition:new Array(),chinesestep:new Array(),chinesestepm:new Array(),chinesepgn:new Array(),chinesepgnm:new Array(),chinesehtml:new Array(),chinesehtmlm:new Array(),wxfstep:new Array(),wxfstepm:new Array(),wxfpgn:new Array(),wxfpgnm:new Array(),wxfhtml:new Array(),wxfhtmlm:new Array(),iccsstep:new Array(),iccsstepm:new Array(),iccspgn:new Array(),iccspgnm:new Array(),iccshtml:new Array(),iccsmhtml:new Array()};vschess.help=(function(){var $html="",$i=1;$html+=$i+".单击“播放”按钮，可以自动播放棋局。<br />";++$i;$html+=$i+".播放过程中，单击“暂停”按钮，棋局停止自动播放。<br />";++$i;$html+=$i+".单击“X秒”按钮，可以选择播放速度。<br />";++$i;$html+=$i+".单击“前进”“后退”按钮，每次变化1步。<br />";++$i;$html+=$i+".按住“前进”“后退”按钮，可以快进与快退。<br />";++$i;$html+=$i+".单击“快进”“快退”按钮，每次变化5个回合，即10步。<br />";++$i;$html+=$i+".单击“功能”按钮，可以复制当前局面，保存棋谱，翻转棋盘等。<br />";++$i;$html+=$i+".多种棋谱格式可选，单击对应的按钮以选择相应的格式。<br />";++$i;$html+=$i+".复制局面后，可以直接在专业象棋软件中粘贴使用。<br />";++$i;$html+=$i+".文字棋盘推荐粘贴到Word中，并设置字体为宋体，调整行距至最佳。<br />";++$i;$html+=$i+".分析局面时，建议将局面复制到专业象棋软件中进行分析。<br />";++$i;$html+=$i+".可以直接在棋盘上走棋，便于分析局面。<br />";++$i;$html+=$i+".在着法列表中可以调整变招顺序或删除着法。<br />";++$i;$html+=$i+".注释修改后直接在注释区外面任意处单击即可保存。<br />";++$i;$html+=$i+".编辑局面会失去当前棋谱，请注意保存。<br />";++$i;$html+=$i+".单击“选项”按钮，可以控制走子声音、走子检查等。<br />";++$i;$html+="----------------------------------------------------------------------------<br />";$html+="本播放器遵循LGPL开源许可协议发布,源码位于https://github.com/letlet/chessplayer<br/>本播放器包含微思象棋播放器，详见："
$html+="微思象棋播放器 &copy; 2009-2013 飞影阁(http://www.fastlight.cn/) 版权所有<br />";return $html;})();vschess.turnfen=function($str){var $i=0,$j=0;var $array=$str.split(" ");var $old=$array[0];var $new="",$oldline=new Array();$old=$old.split("/");for($i=0;$i<10;++$i){$oldline=$old[$i].split("");for($j=$oldline.length-1;$j>=0;--$j){$new+=$oldline[$j];}
if($i!=9){$new+="/";}}
return $new+" "+$array[1]+" - - "+$array[4]+" "+$array[5];};vschess.comment=function($str){var $pgn=$str.indexOf("[Game \"Chinese Chess\"]");if($pgn==-1){return"";}
else{var $format=0,$array=new Array(),$cmt="",$temp="",$temparray=new Array(),$i=0,$j=0;if($str.indexOf("[Format \"ICCS\"]")>=0){$format=1;}
...
if($format==0){$array=$str.split(/[\u8f66\u9a6c\u76f8\u8c61\u4ed5\u58eb\u5e05\u5c06\u70ae\u5175\u5352\u524d\u4e2d\u540e\u4e00\u4e8c\u4e09\u56dB\u4e94][\u8f66\u9a6c\u70ae\u5175\u5352\u4e00\u4e8c\u4e09\u56dB\u4e94\u516d\u4e03\u516b\u4e5d\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19][\u8fdb\u9000\u5e73][\u4e00\u4e8c\u4e09\u56dB\u4e94\u516d\u4e03\u516b\u4e5d\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19]/);}
else if($format==1){$array=$str.split(/[ABCDEFGHI][0-9]-[ABCDEFGHI][0-9]/);}
else{$array=$str.split(/[RNBAKCP][0-9a-e\+\-\.][\+\-\.][0-9]/);}
for($i=0;$i<$array.length;++$i){if($array[$i].indexOf("COMMENT")>=0){$cmt+=$i+"@"+encodeURIComponent($temparray[$j++])+",";}}
$cmt=$cmt.replace(/,$/,"");return $cmt;}};vschess.convertshijia=function($str){var $regexp_fen=/([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+)(?:[\s]+)\+([BbRr])/;var $begin=$regexp_fen.exec($str),$fen_begin="";if($begin){var $qizi=["*","P","P","P","P","P","C","C","N","N","R","R","B","B","A","A","K","p","p","p","p","p","c","c","n","n","r","r","b","b","a","a","k"];var $qipan={52:0,53:1,54:2,55:3,56:4,57:5,58:6,59:7,60:8,68:9,69:10,70:11,71:12,72:13,73:14,74:15,75:16,76:17,84:18,85:19,86:20,87:21,88:22,89:23,90:24,91:25,92:26,100:27,101:28,102:29,103:30,104:31,105:32,106:33,107:34,108:35,116:36,117:37,118:38,119:39,120:40,121:41,122:42,123:43,124:44,132:45,133:46,134:47,135:48,136:49,137:50,138:51,139:52,140:53,148:54,149:55,150:56,151:57,152:58,153:59,154:60,155:61,156:62,164:63,165:64,166:65,167:66,168:67,169:68,170:69,171:70,172:71,180:72,181:73,182:74,183:75,184:76,185:77,186:78,187:79,188:80,196:81,197:82,198:83,199:84,200:85,201:86,202:87,203:88,204:89};var $situation=new Array(),$i=0;for($i=0;$i<90;++$i){$situation.push("*");}
...
$fen_begin+=":2";}
return $fen_begin;};vschess.convertqqnew=function($str){var $temp,$str_each=new Array(),$chessstepregexp=/(?:[0-9]+) 32 (?:[0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) ([0-9]+) 0 (?:[0-9]+) 0/;var $out="rnbakabnr/9/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/9/RNBAKABNR w - - 0 1:",$col;while($temp=$chessstepregexp.exec($str)){$str_each[$str_each.length]=$temp.toString();$str=$str.replace($chessstepregexp,"");switch(parseInt($temp[2])){case 8:$out+="A";break;case 7:$out+="B";break;case 6:$out+="C";break;case 5:$out+="D";break;case 4:$out+="E";break;case 3:$out+="F";break;case 2:$out+="G";break;case 1:$out+="H";break;case 0:$out+="I";break;}
...
$out+=$temp[3];}
return $out+":2";};vschess.convertgloballink=function($str){var $reg=/\u4e2d \u56fd \u8c61 \u68cb \u5bf9 \u5c40 \u8bb0 \u5f55([\S\s]*)\u9ed1\u65b9/;$str=$str.replace($reg,"[Game \"Chinese Chess\"]");return vschess.converter($str);};vschess.converter=function($str){var $i,$j,$k,$break_flag=0;var $box_each=new Array();var $specialsoldier=new Array(),$specialsoldiercol=0;var $row,$col,$colw,$coln,$point,$list="",$cmt="";$cmt=vschess.comment($str);var $pgn=$str.indexOf("[Game \"Chinese Chess\"]");if($pgn==-1&&!/[\u8f66\u9a6c\u76f8\u8c61\u4ed5\u58eb\u5e05\u5c06\u70ae\u5175\u5352\u524d\u4e2d\u540e\u4e00\u4e8c\u4e09\u56dB\u4e94][\u8f66\u9a6c\u76f8\u8c61\u4ed5\u58eb\u70ae\u5175\u5352\u4e00\u4e8c\u4e09\u56dB\u4e94\u516d\u4e03\u516b\u4e5d\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19][\u8fdb\u9000\u5e73][\u4e00\u4e8c\u4e09\u56dB\u4e94\u516d\u4e03\u516b\u4e5d\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19]/.exec($str)){var $format=/(?:[1-9rnhbeakcpRNHBEAKCP]{1,9}\/){9}[1-9rnhbeakcpRNHBEAKCP]{1,9} [w|b|r] - - [0-9]+ [0-9]+:[0-9a-iA-I]+:[0-3]:(.*)/.exec($str);if($format){return $format[0];}
...
$format=/[0-9]+ 32 [0-9+] [0-9+] [0-9+] [0-9+] [0-9+] 0 [0-9+] 0/.exec($str);if($format){return vschess.convertqqnew($str);}
$format=/\u4e2d \u56fd \u8c61 \u68cb \u5bf9 \u5c40 \u8bb0 \u5f55/.exec($str);if($format){return vschess.convertgloballink($str);}
...
if($format==0){var $chessstepregexp=/[\u8f66\u9a6c\u76f8\u8c61\u4ed5\u58eb\u5e05\u5c06\u70ae\u5175\u5352\u524d\u4e2d\u540e\u4e00\u4e8c\u4e09\u56dB\u4e94][\u8f66\u9a6c\u76f8\u8c61\u4ed5\u58eb\u70ae\u5175\u5352\u4e00\u4e8c\u4e09\u56dB\u4e94\u516d\u4e03\u516b\u4e5d\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19][\u8fdb\u9000\u5e73][\u4e00\u4e8c\u4e09\u56dB\u4e94\u516d\u4e03\u516b\u4e5d\uff11\uff12\uff13\uff14\uff15\uff16\uff17\uff18\uff19]/;var $temp1=$str,$temp2,$str_each=new Array();$temp1=$temp1.replace(/\s/g,"").replace(/\((.*)\)/g,"").replace(/\[(.*)\]/g,"").replace(/[0-9]+\./g,"").replace(/\{([^{^}]*)\}/g,"").replace(/1\-0(.*)/g,"").replace(/0\-1(.*)/g,"").replace(/1\/2\-1\/2(.*)/g,"").replace(/\*(.*)/g,"");while($temp2=$chessstepregexp.exec($temp1)){$str_each[$str_each.length]=$temp2[0];$temp1=$temp1.replace($chessstepregexp,"");}}
else if($format==1){var $chessstepregexp=/[a-iA-I][0-9]-[a-iA-I][0-9]/;$str=$str.replace(/[0-9]+\./g,"").replace(/\s/g,"").replace(/\((.*)\)/g,"").replace(/\[(.*)\]/g,"").replace(/\{([^{^}]*)\}/g,"").replace(/1-0(.*)/g,"").replace(/0-1(.*)/g,"").replace(/1\/2-1\/2(.*)/g,"").replace(/\*(.*)/g,"").replace(/-/g,"");if($cmt){return $fen_begin+":"+$str+":"+$final+":"+$cmt;}
else{return $fen_begin+":"+$str+":"+$final;}}
else{var $chessstepregexp=/[RNHBEAKCPrnhbeakcp][0-9a-eA-E\+\-\.][\+\-\.][0-9]/;var $temp1=$str,$temp2,$str_each=new Array();$temp1=$str.replace(/\s/g,"").replace(/\((.*)\)/g,"").replace(/\[(.*)\]/g,"").replace(/\{([^{^}]*)\}/g,"").replace(/1-0(.*)/g,"").replace(/0-1(.*)/g,"").replace(/1\/2-1\/2(.*)/g,"").replace(/\*(.*)/g,"").toLowerCase();while($temp2=$chessstepregexp.exec($temp1)){$str_each[$str_each.length]=$temp2.toString();$temp1=$temp1.replace($chessstepregexp,"");}
for($i=0;$i<$str_each.length;++$i){if(($wxfplayer+$i)%2==0){$str_each[$i]=$str_each[$i].replace("r+","\u524d\u8f66").replace("r-","\u540e\u8f66").replace("n+","\u524d\u9a6c").replace("n-","\u540e\u9a6c").replace("h+","\u524d\u9a6c").replace("h-","\u540e\u9a6c").replace("c+","\u524d\u70ae").replace("c-","\u540e\u70ae").replace("p+","\u524d\u5175").replace("p.","\u4e2d\u5175").replace("p-","\u540e\u5175").replace("pa","\u4e00\u5175").replace("pb","\u4e8c\u5175").replace("pc","\u4e09\u5175").replace("pd","\u56dB\u5175").replace("pe","\u4e94\u5175").replace("r","\u8f66").replace("n","\u9a6c").replace("h","\u9a6c").replace("b","\u76f8").replace("e","\u76f8").replace("a","\u4ed5").replace("k","\u5e05").replace("c","\u70ae").replace("p","\u5175").replace(/1/g,"\u4e00").replace(/2/g,"\u4e8c").replace(/3/g,"\u4e09").replace(/4/g,"\u56dB").replace(/5/g,"\u4e94").replace(/6/g,"\u516d").replace(/7/g,"\u4e03").replace(/8/g,"\u516b").replace(/9/g,"\u4e5d").replace("+","\u8fdb").replace("-","\u9000").replace(".","\u5e73");}
...
else if($i<83&&!$ismine($i+7)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i+17]="n";if(!vschess.checkthreat($jumian,"b")){return false;}}}}
...
else if($i<79&&!$ismine($i+11)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i+11]="n";if(!vschess.checkthreat($jumian,"b")){return false;}}}}
...
else if($i%9<8&&!$ismine($i-17)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i-17]="n";if(!vschess.checkthreat($jumian,"b")){return false;}}}}
...
else if($i%9<8&&!$ismine($i+19)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i+19]="n";if(!vschess.checkthreat($jumian,"b")){return false;}}}}
break;}
...
else if($i<83&&!$ismine($i+7)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i+7]="N";if(!vschess.checkthreat($jumian,"w")){return false;}}}}
...
else if($i<79&&!$ismine($i+11)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i+11]="N";if(!vschess.checkthreat($jumian,"w")){return false;}}}}
...
else if($i%9<8&&!$ismine($i-17)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i-17]="N";if(!vschess.checkthreat($jumian,"w")){return false;}}}}
...
else if($i%9<8&&!$ismine($i+19)){$jumian=$originaljumian.clone();$jumian[$i]="*";$jumian[$i+19]="N";if(!vschess.checkthreat($jumian,"w")){return false;}}}}
break;}
...
return $chinese[1];}};vschess.init=function(){var $i=0;if($("#vschess_message").length==0){vschess.pics={board:vschess.picpath+"board.png",nor:vschess.picpath+vschess.chessmanstyle+"/nor.png",rr:vschess.picpath+vschess.chessmanstyle+"/rr.png",rrs:vschess.picpath+vschess.chessmanstyle+"/rrs.png",rn:vschess.picpath+vschess.chessmanstyle+"/rn.png",rns:vschess.picpath+vschess.chessmanstyle+"/rns.png",rb:vschess.picpath+vschess.chessmanstyle+"/rb.png",rbs:vschess.picpath+vschess.chessmanstyle+"/rbs.png",ra:vschess.picpath+vschess.chessmanstyle+"/ra.png",ras:vschess.picpath+vschess.chessmanstyle+"/ras.png",rk:vschess.picpath+vschess.chessmanstyle+"/rk.png",rks:vschess.picpath+vschess.chessmanstyle+"/rks.png",rc:vschess.picpath+vschess.chessmanstyle+"/rc.png",rcs:vschess.picpath+vschess.chessmanstyle+"/rcs.png",rp:vschess.picpath+vschess.chessmanstyle+"/rp.png",rps:vschess.picpath+vschess.chessmanstyle+"/rps.png",br:vschess.picpath+vschess.chessmanstyle+"/br.png",brs:vschess.picpath+vschess.chessmanstyle+"/brs.png",bn:vschess.picpath+vschess.chessmanstyle+"/bn.png",bns:vschess.picpath+vschess.chessmanstyle+"/bns.png",bb:vschess.picpath+vschess.chessmanstyle+"/bb.png",bbs:vschess.picpath+vschess.chessmanstyle+"/bbs.png",ba:vschess.picpath+vschess.chessmanstyle+"/ba.png",bas:vschess.picpath+vschess.chessmanstyle+"/bas.png",bk:vschess.picpath+vschess.chessmanstyle+"/bk.png",bks:vschess.picpath+vschess.chessmanstyle+"/bks.png",bc:vschess.picpath+vschess.chessmanstyle+"/bc.png",bcs:vschess.picpath+vschess.chessmanstyle+"/bcs.png",bp:vschess.picpath+vschess.chessmanstyle+"/bp.png",bps:vschess.picpath+vschess.chessmanstyle+"/bps.png",no:vschess.picpath+vschess.chessmanstyle+"/no.png",nos:vschess.picpath+vschess.chessmanstyle+"/nos.png"};vschess.style=(function(){var $str=".vschess_loaded{";$str+="background-image:url("+vschess.pics.board+");";$str+="background-repeat:no-repeat;";$str+="background-position:0px 0px;";$str+="display:block;";$str+="width:549px;";$str+="height:433px;";$str+="position:relative;";$str+="padding:8px 0px 0px 9px;";$str+="}";$str+=".vschess_loaded *,";$str+="#vschess_message *,";$str+="#vschess_file *,";$str+="#vschess_message,";$str+="#vschess_file{";$str+="margin:0px;";$str+="padding:0px;";$str+="font-size:10pt;";$str+="}";$str+=".vschess_loaded ul,";$str+=".vschess_loaded li{";$str+="list-style-type:none !important;";$str+="}";$str+=".vschess_loaded div.vschess_info{";$str+="display:block;";$str+="width:185px;";$str+="margin-top:-8px;";$str+="float:right;";$str+="overflow:hidden;";$str+="}";$str+=".vschess_loaded div.vschess_config{";$str+="display:none;";$str+="position:absolute;";$str+="top:345px;";$str+="left:390px;";$str+="z-index:1000;";$str+="overflow:hidden;";$str+="padding:10px;";$str+="background-color:#FFF;";$str+="border:solid 3px #999;";$str+="border-radius:10px;";$str+="}";$str+=".vschess_loaded ul.steps{";$str+="display:block;";$str+="float:right;";$str+="padding:2px 0px 2px 8px;";$str+="width:173px;";$str+="height:200px;";$str+="overflow-x:hidden;";$str+="overflow-y:scroll;";$str+="border-top:solid 1px #ACD4C0;";$str+="}";$str+=".vschess_loaded ul.steps li.start{";$str+="display:block;";$str+="float:left;";$str+="width:150px;";$str+="height:20px;";$str+="text-align:center;";$str+="cursor:pointer;";$str+="font-size:10px;";$str+="}";$str+=".vschess_loaded ul.steps li.stepnum{";$str+="display:block;";$str+="float:left;";$str+="width:30px;";$str+="height:20px;";$str+="line-height:20px !important;";$str+="text-align:left;";$str+="margin-left:3px";$str+="font-size:10px;";$str+="}";$str+=".vschess_loaded ul.steps li.step{";$str+="display:block;";$str+="float:left;";$str+="width:60px;";$str+="height:20px;";$str+="line-height:20px !important;";$str+="text-align:center;";$str+="cursor:pointer;";$str+="font-size:10px;";$str+="}";$str+=".vschess_loaded textarea.vschess_comment{";$str+="font-size:10px;";$str+="display:block;";$str+="float:right;";$str+="margin-top:2px;";$str+="padding:5px;";$str+="width:169px;";$str+="height:198px;";$str+="overflow-x:hidden;";$str+="overflow-y:scroll;";$str+="text-align:left;";$str+="resize:none;";$str+="border:none;";$str+="border-top:solid 1px #ACD4C0;";$str+="}";$str+=".vschess_loaded img.vschess_box{";$str+="display:block;";$str+="float:left;";$str+="position:relative;";$str+="height:40px;";$str+="width:40px;";$str+="border:none;";$str+="margin:0px;";$str+="padding:0px;";$str+="z-index:1000;";$str+="}";$str+=".vschess_loaded img.vschess_boxfloat{";$str+="display:none;";$str+="position:absolute;";$str+="background-image:url("+vschess.pics.nos+");";$str+="height:40px;";$str+="width:40px;";$str+="border:none;";$str+="margin:0px;";$str+="padding:0px;";$str+="z-index:2000;";$str+="}";$str+=".vschess_loaded div.vschess_bar{";$str+="display:block;";$str+="float:left;";$str+="margin-top:1px;";$str+="margin-left:-10px;";$str+="width:600px;";$str+="}";$str+=".vschess_loaded div.vschess_bar input{";$str+="display:block;";$str+="float:left;";$str+="height:22px;";$str+="width:38px;";$str+="font-size:9pt;";$str+="cursor:pointer;";$str+="padding:0px;";$str+="}";$str+=".vschess_loaded div.vschess_makebar{";$str+="display:none;";$str+="float:left;";$str+="margin-top:1px;";$str+="margin-left:-9px;";$str+="width:560px;";$str+="}";$str+=".vschess_loaded div.vschess_makebar input{";$str+="display:block;";$str+="float:left;";$str+="height:22px;";$str+="width:45px;";$str+="font-size:9pt;";$str+="cursor:pointer;";$str+="padding:0px;";$str+="}";$str+=".vschess_loaded div.vschess_bar input.vsbar_config{width:45px;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_format{width:45px;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_ctrl{color:#008000;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_play{color:#008000;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_view{color:#008000;width:76px;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_time{color:#000099;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_func{color:#000099;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_help{color:#000099;}";$str+=".vschess_loaded div.vschess_bar input.vsbar_pause{color:#FF0000;}";$str+=".vschess_loaded div.vschess_bar ul{";$str+="display:none;";$str+="position:absolute;";$str+="z-index:3000;";$str+="background-color:#FFF;";$str+="border:1px solid #999;";$str+="padding:3px;";$str+="overflow:hidden;";$str+="background-color:#FFC;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_timelist{left:266px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_funclist{left:304px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_funclist li{";$str+="background-image:url("+vschess.picpath+"menu.png);";$str+="background-repeat:no-repeat;";$str+="text-indent:16px;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_savelist li{";$str+="background-image:url("+vschess.picpath+"save.png);";$str+="background-repeat:no-repeat;";$str+="text-indent:16px;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_pstnlist li{";$str+="background-image:url("+vschess.picpath+"turn.png);";$str+="background-repeat:no-repeat;";$str+="text-indent:16px;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_timelist li{";$str+="background-image:url("+vschess.picpath+"menu.png);";$str+="background-repeat:no-repeat;";$str+="background-position:0px -163px;";$str+="text-indent:16px;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul li{";$str+="display:block;";$str+="position:relative;";$str+="height:18px;";$str+="line-height:18px;";$str+="padding-right:3px;";$str+="padding-left:3px;";$str+="font-size:9pt;";$str+="color:#000;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul li a{";$str+="font-size:9pt;";$str+="color:#000;";$str+="}";$str+=".vschess_loaded div.vschess_bar ul li:hover,";$str+=".vschess_loaded div.vschess_bar ul li:hover a,";$str+=".vschess_loaded div.vschess_bar ul li.hover,";$str+=".vschess_loaded div.vschess_bar ul li.hover a{";$str+="background-color:#CCC;";$str+="cursor:pointer;";$str+="color:#000;";$str+="}";$str+=".vschess_loaded div.vschess_bar span.vsbar_listarrow{";$str+="display:inline-block;";$str+="font-family:\"宋体\";";$str+="line-height:10px;";$str+="text-indent:-8px;";$str+="overflow:hidden;";$str+="margin-left:3px;";$str+="}";$str+=".vschess_loaded ul.vschess_node{";$str+="display:none;";$str+="position:absolute;";$str+="height:100px;";$str+="width:146px;";$str+="border:solid 1px #ACD4C0;";$str+="margin:20px 0 0 0;";$str+="padding:0px;";$str+="z-index:2000;";$str+="left:558px;";$str+="overflow-x:hidden;";$str+="overflow-y:scroll;";$str+="background-color:#FFF;";$str+="padding:2px;";$str+="}";$str+=".vschess_loaded ul.vschess_node li{";$str+="height:20px;";$str+="width:120px;";$str+="line-height:20px !important;";$str+="font-size:10px;";$str+="text-align:left;";$str+="padding-left:5px;";$str+="padding-right:5px;";$str+="}";$str+=".vschess_loaded ul.vschess_node li span{";$str+="float:right;";$str+="margin-left:5px;";$str+="cursor:pointer;";$str+="}";$str+=".vschess_loaded ul.vschess_node li span.step{";$str+="float:left;";$str+="margin-left:0px;";$str+="cursor:pointer;";$str+="}";$str+=".vschess_loaded ul.vschess_node li.current{";$str+="background-color:#0EE;";$str+="}";$str+=".vschess_loaded div.vschess_node_title{";$str+="display:none;";$str+="position:absolute;";$str+="height:20px;";$str+="width:150px;";$str+="border:solid 1px #ACD4C0;";$str+="margin:-1px 0 0 0;";$str+="padding:0px;";$str+="z-index:2000;";$str+="text-indent:43px;";$str+="line-height:20px !important;";$str+="left:558px;";$str+="font-weight:bolder;";$str+="background-color:#FFF;";$str+="font-size:10px;";$str+="}";$str+=".vschess_loaded div.vschess_node_close{";$str+="display:none;";$str+="position:absolute;";$str+="height:20px;";$str+="width:20px;";$str+="margin:0px;";$str+="padding:0px;";$str+="z-index:2000;";$str+="text-align:center;";$str+="line-height:20px !important;";$str+="cursor:pointer;";$str+="left:689px;";$str+="color:#F00;";$str+="font-weight:bolder;";$str+="background-color:#FFF;";$str+="}";$str+="#vschess_message{";$str+="display:none;";$str+="position:fixed;";$str+="top:50%;";$str+="left:50%;";$str+="padding:10px;";$str+="white-space:nowrap;";$str+="background-color:#FFF;";$str+="border:solid 3px #999;";$str+="border-radius:10px;";$str+="z-index:10000;";$str+="}";$str+="#vschess_message a{text-decoration:none;}";$str+="#vschess_file{";$str+="display:none;";$str+="position:fixed;";$str+="top:50%;";$str+="left:50%;";$str+="padding:10px;";$str+="background-color:#FFF;";$str+="border:solid 3px #999;";$str+="border-radius:10px;";$str+="z-index:8000;";$str+="}";$str+="#vschess_file textarea{";$str+="font-family:\"宋体\";";$str+="resize:none";$str+="}";$str+=".vschess_loaded ul.steps li.start,";$str+=".vschess_loaded ul.steps li.stepnum,";$str+=".vschess_loaded ul.steps li.step,";$str+=".vschess_loaded ul.vschess_node li,";$str+=".vschess_loaded textarea.vschess_comment,";$str+=".vschess_loaded div.vschess_node_title{";$str+="font-size:12px;";$str+="}";$str+=".vschess_loaded div.vschess_make{";$str+="display:none;";$str+="padding:8px;";$str+="width:162px;";$str+="height:400px;";$str+="background-color:#FFF;";$str+="z-index:9999;";$str+="position:absolute;";$str+="top:0px;";$str+="left:378px;";$str+="border:solid 1px #ACD4C0;";$str+="font-size:12px";$str+="}";$str+=".vschess_loaded div.vschess_make img{float:left;}";$str+=".vschess_loaded div.vschess_make span{cursor:pointer;}";$str+=".vschess_loaded div.vschess_make div{";$str+="float:left;";$str+="width:165px;";$str+="margin-top:8px;";$str+="}";if(IE6){$str+=".vschess_loaded div.vschess_bar{margin-left:-5px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_timelist{width:56px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_funclist{width:78px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_pstnlist{width:76px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_savelist{width:150px;}";$str+=".vschess_loaded div.vschess_bar ul.vsbar_bloglist{width:76px;}";$str+=".vschess_loaded div.vschess_bar ul li{";$str+="display:block;";$str+="position:relative;";$str+="list-style-type:none;";$str+="height:18px;";$str+="padding-right:3px;";$str+="padding-left:3px;";$str+="font-size:9pt;";$str+="}";$str+="#vschess_message,#vschess_file{position:absolute;}";$str+=".vschess_loaded div.vschess_makebar{";$str+="position:absolute;";$str+="left:9px;";$str+="top:416px;";$str+="}";}
return $str;})();$("head").append("<style>"+vschess.style+"</style>");var $html='<div id="vschess_message"></div>';$html+='<div id="vschess_file">';$html+='<span id="vschess_file_info">请单击“保存”来保存此棋谱。</span><br />';$html+='<form action="'+vschess.server+'action=save" method="post" id="vschess_post">';$html+='<textarea name="content" rows="10" cols="50" style="margin-top:5px;margin-left:0px;" readonly="readonly"></textarea><br />';$html+='<input type="button" value="确定" style="float:right;width:50px;margin-top:5px;margin-left:5px;" class="vschess_file_close" />';$html+='<input type="button" value="复制" style="float:right;width:50px;margin-top:5px;margin-left:5px;" id="vschesscopybutton" />';if(vschess.server){$html+='<input type="submit" value="保存" style="float:right;width:50px;margin-top:5px;margin-left:5px;" class="vschess_file_close" />';}
...
else if(vschess.checkthreat($baiqi_fen,"w")){$stepnow.css("background-color","#FCC");}}};vschess.putchessman[$chessid]=function($putstep){$baiqi($jumian_each[$putstep],$putstep);};(function(){$ctrlbar='<div class="vschess_bar">';$ctrlbar+='<input type="button" class="vsbar_first" value="开局" title="返回初始局面" disabled="disabled" />';$ctrlbar+='<input type="button" class="vsbar_prev10" value="快退" title="后退10步" disabled="disabled" />';$ctrlbar+='<input type="button" class="vsbar_prev" value="后退" title="单击后退1步，按住快速后退" disabled="disabled" />';$ctrlbar+='<input type="button" class="vsbar_ctrl" value="播放" title="自动播放棋谱" />';$ctrlbar+='<input type="button" class="vsbar_view vsbar_pause" title="暂停收看直播" value="暂停收看" style="display:none;" />';$ctrlbar+='<input type="button" class="vsbar_play vsbar_pause" title="暂停播放棋谱" value="暂停" style="display:none;" />';$ctrlbar+='<input type="button" class="vsbar_stop vsbar_pause" title="结束直播" value="结束" style="display:none;" />';$ctrlbar+='<input type="button" class="vsbar_next" value="前进" title="单击前进1步，按住快速前进" />';$ctrlbar+='<input type="button" class="vsbar_next10" value="快进" title="前进10步" />';$ctrlbar+='<input type="button" class="vsbar_last" value="终局" title="前往最终局面" />';$ctrlbar+='<input type="button" class="vsbar_time" value="0.5秒" title="选择播放速度" />';$ctrlbar+='<input type="button" class="vsbar_func" value="功能" title="复制局面、保存棋谱、微博分享等功能" />';$ctrlbar+='<input type="button" class="vsbar_help" value="帮助" title="查看帮助" />';$ctrlbar+='<input type="button" class="vsbar_config" value="选项" title="可控制声音、走子检查等" style="color:#C0C;" />';$ctrlbar+='<input type="button" class="vsbar_format vsbar_chinese" value="中文" title="中文格式棋谱" />';$ctrlbar+='<input type="button" class="vsbar_format vsbar_wxf" value="WXF" title="WXF纵线格式棋谱" />';$ctrlbar+='<input type="button" class="vsbar_format vsbar_iccs" value="ICCS" title="ICCS坐标格式棋谱" />';$ctrlbar+='<ul class="vsbar_timelist">';$ctrlbar+='<li name="50" title="播放速度为每步5秒">5秒</li>';$ctrlbar+='<li name="20" title="播放速度为每步2秒">2秒</li>';$ctrlbar+='<li name="10" title="播放速度为每步1秒">1秒</li>';$ctrlbar+='<li name="5" title="播放速度为每步0.5秒">0.5秒</li>';$ctrlbar+='<li name="2" title="播放速度为每步0.2秒">0.2秒</li>';$ctrlbar+='<li name="1" title="播放速度为每步0.1秒">0.1秒</li>';$ctrlbar+='</ul><ul class="vsbar_funclist">';$ctrlbar+='<li class="vsbar_copy" style="background-position:0px -1px;" id="vschess_copy_'+$chessid+'" title="复制当前局面的FEN码">复制局面</li>';$ctrlbar+='<li class="vsbar_edit" style="background-position:0px -19px;" title="编辑起始局面">编辑局面</li>';$ctrlbar+='<li class="vsbar_view" style="background-position:0px -37px;" title="查看棋谱代码">查看棋谱<span class="vsbar_listarrow">◆</span></li>';if(vschess.server){$ctrlbar+='<li class="vsbar_save" style="background-position:0px -55px;" title="保存棋谱文件">保存棋谱<span class="vsbar_listarrow">◆</span></li>';}
$ctrlbar+='<li class="vsbar_pstn" style="background-position:0px -73px;" title="改变棋盘方向">棋盘翻转<span class="vsbar_listarrow">◆</span></li>';if(vschess.server){$ctrlbar+='<li class="vsbar_pic" style="background-position:0px -109px;" title="生成当前局面的截图">生成截图</li>';}
$ctrlbar+='<li class="vsbar_text" style="background-position:0px -145px;" title="查看文字棋盘，可用于不能使用图片的场合">文字棋盘</li>';$ctrlbar+='</ul><ul class="vsbar_savelist">';$ctrlbar+='<li class="vsbar_pgn"  style="background-position:0px  -1px;" title="标准象棋PGN格式">标准象棋PGN格式</li>';$ctrlbar+='<li class="vsbar_pfc"  style="background-position:0px -19px;" title="鹏飞象棋PFC格式">鹏飞象棋PFC格式</li>';$ctrlbar+='<li class="vsbar_dpxq" style="background-position:0px -55px;" title="东萍象棋DhtmlXQ格式">东萍象棋DhtmlXQ格式</li>';$ctrlbar+='<li class="vsbar_qq"   style="background-position:0px -37px;" title="QQ象棋CHE格式">QQ象棋CHE格式</li>';$ctrlbar+='</ul><ul class="vsbar_pstnlist">';$ctrlbar+='<li class="vsbar_turn" style="background-position:0px  -1px;" title="将棋盘旋转180度">对角旋转</li>';$ctrlbar+='<li class="vsbar_updn" style="background-position:0px -37px;" title="将棋盘上下翻转">上下翻转</li>';$ctrlbar+='<li class="vsbar_ltrt" style="background-position:0px -19px;" title="将棋盘左右翻转">左右翻转</li>';$ctrlbar+='</ul></div>';$ctrlbar+='<div class="vschess_makebar">';$ctrlbar+='<input type="text" class="vschess_editfen" style="width:377px;height:20px;line-height:20px;border:solid 1px #ACD4C0;text-indent:3px;cursor:auto;" />';$ctrlbar+='<input type="button" class="vschess_editbegin"  value="开局" title="将局面恢复到开局状态" />';$ctrlbar+='<input type="button" class="vschess_editclean"  value="清空" title="清空棋盘，只剩将帅" />';$ctrlbar+='<input type="button" class="vschess_editfinish" value="完成" title="完成编辑局面" />';$ctrlbar+='<input type="button" class="vschess_editcancel" value="取消" title="取消编辑局面" />';$ctrlbar+='</div>';$this.append($ctrlbar);})();if(vschess.oldcontent[$chessid].indexOf("n version")>-1){$pfdom=vschess.pfchess[$chessid]=$(vschess.oldcontent[$chessid].replace("<!--","").replace("-->","").replace(/<\?xml(.*)\?>/,"").replace(/<n/ig,"<div").replace(/<\/n>/ig,"</div>"));}
...
return $each;};var $dpstep=function($array){var $temp="";switch($array[0]){case 0:$temp+="a";break;case 1:$temp+="b";break;case 2:$temp+="c";break;case 3:$temp+="d";break;case 4:$temp+="e";break;case 5:$temp+="f";break;case 6:$temp+="g";break;case 7:$temp+="h";break;case 8:$temp+="i";break;}
$temp+=9-$array[1];switch($array[2]){case 0:$temp+="a";break;case 1:$temp+="b";break;case 2:$temp+="c";break;case 3:$temp+="d";break;case 4:$temp+="e";break;case 5:$temp+="f";break;case 6:$temp+="g";break;case 7:$temp+="h";break;case 8:$temp+="i";break;}
$temp+=9-$array[3];return $temp;};var $dprepeat=function($num){var $temp="";for(var $i=0;$i<$num;++$i){$temp+="</div>";}
return $temp;};var $regexp_dpfen=/\[DhtmlXQ_binit\]([0-9]*)\[\/DhtmlXQ_binit\]/;var $regexp_dpmovelist=/\[DhtmlXQ_movelist\]([0-9]*)\[\/DhtmlXQ_movelist\]/;var $regexp_dpotherlist=/\[DhtmlXQ_move_([0-9]+)_([0-9]+)_([0-9]+)\]([0-9]*)\[\/DhtmlXQ_move_(?:[0-9]+)_(?:[0-9]+)_(?:[0-9]+)\]/;var $regexp_dpcomment_main=/\[DhtmlXQ_comment([0-9]+)\](.*)\[\/DhtmlXQ_comment(?:[0-9]+)\]/;var $regexp_dpcomment_other=/\[DhtmlXQ_comment([0-9]+)_([0-9]+)\](.*)\[\/DhtmlXQ_comment(?:[0-9]+)_(?:[0-9]+)\]/;var $temp_dp=vschess.oldcontent[$chessid].replace("<!--","").replace("-->","").replace(/\[\/DhtmlXQ_comment([0-9]+)\]\[DhtmlXQ_comment([0-9]+)\]/g,"[/DhtmlXQ_comment$1]\n[DhtmlXQ_comment$2]").replace(/\[\/DhtmlXQ_comment([0-9]+)\]\[DhtmlXQ_comment([0-9]+)_([0-9]+)\]/g,"[/DhtmlXQ_comment$1]\n[DhtmlXQ_comment$2_$3]").replace(/\[\/DhtmlXQ_comment([0-9]+)_([0-9]+)\]\[DhtmlXQ_comment([0-9]+)\]/g,"[/DhtmlXQ_comment$1_$2]\n[DhtmlXQ_comment$3]").replace(/\[\/DhtmlXQ_comment([0-9]+)_([0-9]+)\]\[DhtmlXQ_comment([0-9]+)_([0-9]+)\]/g,"[/DhtmlXQ_comment$1_$2]\n[DhtmlXQ_comment$3_$4]");var $dpfen=$regexp_dpfen.exec(vschess.oldcontent[$chessid].replace("<!--","").replace("-->",""))[1].split(""),$temp_dp_each;var $dpmovelist=$regexp_dpmovelist.exec(vschess.oldcontent[$chessid].replace("<!--","").replace("-->",""))[1].split("");var $dp2fen=new Array(),$dp2fen_man="*",$dp2fen_final="";for($i=0;$i<90;++$i){$dp2fen.push("*");}
...
while($temp_dp_each=$regexp_dpcomment_main.exec($temp_dp)){$dpcomment_each["dp_0_"+$temp_dp_each[1]]=$temp_dp_each[2].replace(/\|\|/g,"\n");$temp_dp=$temp_dp.replace($regexp_dpcomment_main,"");}
while($temp_dp_each=$regexp_dpcomment_other.exec($temp_dp)){$dpcomment_each["dp_"+$temp_dp_each[1]+"_"+$temp_dp_each[2]]=$temp_dp_each[3].replace(/\|\|/g,"\n");$temp_dp=$temp_dp.replace($regexp_dpcomment_other,"");}
var $dpmainstr='<div version="2" win="*" create-time="*" m="'+$dp2fen_final+'"';if($dpcomment_each["dp_0_0"]){$dpmainstr+=' c="'+$dpcomment_each["dp_0_0"]+'"';}
$dpmainstr+=">";$dplen=$dpmovelist_each.length;for($i=1;$i<=$dplen;++$i){$dpmainstr+='<div m="'+$dpstep($dpmovelist_each[$i-1])+'" step="'+$i+'" id="dp_0_'+$i+'"';if($dpcomment_each["dp_0_"+$i]){$dpmainstr+=' c="'+$dpcomment_each["dp_0_"+$i]+'"';}
$dpmainstr+=">";}
$pfdom=vschess.pfchess[$chessid]=$($dpmainstr+$dprepeat($dplen+1));var $dpadd,$dpcurrentstep,$dpotherlist,$regexp_dpcomment;while($temp_dp_each=$regexp_dpotherlist.exec($temp_dp)){$dpotherlist=$dpgroup($temp_dp_each[4].split(""),4);$pfdom=vschess.pfchess[$chessid].find("#dp_"+$temp_dp_each[1]+"_"+$temp_dp_each[2]);$dpcurrentstep=parseInt($pfdom.attr('step'));$dplen=$dpotherlist.length;$dpadd="";for($j=0;$j<$dplen;++$j){$dpadd+='<div m="'+$dpstep($dpotherlist[$j])+'"';$dpadd+=' step="'+$dpcurrentstep+'"';$dpadd+=' id="dp_'+$temp_dp_each[3]+'_'+$dpcurrentstep+'"';if($dpcomment_each["dp_"+$temp_dp_each[3]+"_"+$dpcurrentstep]){$dpadd+=' c="'+$dpcomment_each["dp_"+$temp_dp_each[3]+"_"+$dpcurrentstep]+'"';}
$dpadd+=">";++$dpcurrentstep;}
$pfdom.after($dpadd+$dprepeat($dplen.length));$temp_dp=$temp_dp.replace($regexp_dpotherlist,"");}
...
+"&mode=setdom",{dom:$pfstr});}};vschess.automove[$chessid]=setInterval(function(){if(vschess.play[$chessid]==1&&vschess.time_each[$chessid]%vschess.time[$chessid]==0){$this.find("img.vschess_box").css("background-image","");vschess.api.id($chessid).hidenodelist();++vschess.step[$chessid];if(vschess.step[$chessid]>=0){$this.find("input.vsbar_first,input.vsbar_prev10,input.vsbar_prev").attr("disabled",false);}
...
++vschess.time_each[$chessid];if(vschess.time_each[$chessid]>99){vschess.time_each[$chessid]=0;}},100);var $makefen=function($position){if(vschess.checkmove[$chessid]==1){var $R=0,$N=0,$B=0,$A=0,$K=0,$C=0,$P=0,$r=0,$n=0,$b=0,$a=0,$k=0,$c=0,$p=0,$Pcol=0,$pcol=0;for($i=0;$i<90;++$i){switch($position[$i]){case"R":++$R;break;case"r":++$r;break;case"N":++$N;break;case"n":++$n;break;case"C":++$C;break;case"c":++$c;break;case"K":{++$K;if($i!=66&&$i!=67&&$i!=68&&$i!=75&&$i!=76&&$i!=77&&$i!=84&&$i!=85&&$i!=86){return false;}
for($j=$i-9;$j>0;$j-=9){if($position[$j]=="*"){continue;}
if($position[$j]=="k"){return false;}
if($position[$j]!="k"){break;}}
break;}
case"k":{++$k;if($i!=3&&$i!=4&&$i!=5&&$i!=12&&$i!=13&&$i!=14&&$i!=21&&$i!=22&&$i!=23){return false;}
for($j=$i+9;$j<90;$j+=9){if($position[$j]=="*"){continue;}
if($position[$j]=="K"){return false;}
if($position[$j]!="K"){break;}}
break;}
case"A":{++$A;if($i!=66&&$i!=68&&$i!=76&&$i!=84&&$i!=86){return false;}
break;}
case"a":{++$a;if($i!=3&&$i!=5&&$i!=13&&$i!=21&&$i!=23){return false;}
break;}
case"B":{++$B;if($i!=47&&$i!=51&&$i!=63&&$i!=67&&$i!=71&&$i!=83&&$i!=87){return false;}
break;}
case"b":{++$b;if($i!=2&&$i!=6&&$i!=18&&$i!=22&&$i!=26&&$i!=38&&$i!=42){return false;}
break;}
case"P":{++$P;$Pcol=$i%9;if($i>=45&&$Pcol!=0&&$Pcol!=2&&$Pcol!=4&&$Pcol!=6&&$Pcol!=8){return false;}
...
if($B>2||$b>2){return false;}
if($A>2||$a>2){return false;}
if($C>2||$c>2){return false;}
...
else{return false;}}};var $checklegal=function($from,$to,$cplayer){switch(vschess.turn[$chessid]){case 1:$from=89-$from;$to=89-$to;break;case 2:$from=8+$from-$from%9*2;$to=8+$to-$to%9*2;break;case 3:$from=81-$from+$from%9*2;$to=81-$to+$to%9*2;break;}
...
break;}
default:return false;break;}
return true;};var $movechessman=function($movestrin){var $currentstepid=vschess.api.id($chessid).step();var $movethisdom=vschess.pfchess[$chessid];for($i=0;$i<$currentstepid;++$i){if($movethisdom.children("div[default]").length==0){$movethisdom=$movethisdom.children("div:eq(0)").attr("default",true);}
...
else{vschess.sound.move();}}};var $movetips=function($from){if(vschess.tips[$chessid]==0||$from==-1){$this.find("img.vschess_box:not(:eq("+$from+"))").css("background-image","");}
...
vschess.pfreload[$chessid]();vschess.api.id($chessid);vschess.api.step(vschess.api.step());vschess.api.format(vschess.api.format());if($arguments.live=="play"){vschess.senddom[$chessid]();}};if($arguments.live!="view"){$bindclick();}
(function(){$(window).mouseup(function(){$fasttime=0;clearInterval($fastinterval);});$this.find("div.vschess_node_close").click(function(){vschess.api.id($chessid).hidenodelist();});$this.find("ul.vsbar_funclist li,ul.vsbar_timelist li,ul.vsbar_savelist li,ul.vsbar_pstnlist li,ul.vsbar_bloglist li").hover(function(){$this.find(".vsbar_funclist li,.vsbar_timelist li,.vsbar_savelist li,.vsbar_pstnlist li").removeClass("hover");$(this).addClass("hover");},function(){$(this).removeClass("hover");});$this.find("textarea.vschess_comment").change(function(){$changecomment();});$this.find("textarea.vschess_comment").keydown(function(){if(window.event.keyCode==13&&event.ctrlKey){$changecomment();}});$this.find("input.vsbar_first").click(function(){$fasttime=0;clearInterval($fastinterval);if($arguments.live!="view"||vschess.livepause[$chessid]){$this.find(":animated").stop().hide();vschess.api.id($chessid).play(0).step(0);}});$this.find("input.vsbar_prev10").click(function(){$fasttime=0;clearInterval($fastinterval);if($arguments.live!="view"||vschess.livepause[$chessid]){$this.find(":animated").stop().hide();vschess.api.id($chessid).play(0).step(vschess.api.id($chessid).step()-10);}});$this.find("input.vsbar_prev").mouseup(function(){$fasttime=0;clearInterval($fastinterval);if($arguments.live!="view"||vschess.livepause[$chessid]){$this.find(":animated").stop().hide();vschess.api.id($chessid)
vschess.api.play(0).step(vschess.api.step()-1);}}).mousedown(function(){vschess.api.id($chessid);$fasttime=0;clearInterval($fastinterval);$fastinterval=setInterval(function(){if($fasttime<10){++$fasttime;}
else{vschess.api.step(vschess.api.step()-1);if(vschess.api.step()==0){$fasttime=0;clearInterval($fastinterval);}}},50);}).mouseout(function(){$fasttime=0;clearInterval($fastinterval);});$this.find("input.vsbar_ctrl").click(function(){$fasttime=0;clearInterval($fastinterval);if(vschess.play[$chessid]==1||$jumian_each.length==1){vschess.api.id($chessid).play(0);}
else{vschess.api.id($chessid).play(1);}});$this.find("input.vsbar_view,input.vsbar_play").click(function(){$fasttime=0;clearInterval($fastinterval);if(vschess.livepause[$chessid]===true){vschess.api.id($chessid).livepause(false);}
else{vschess.api.id($chessid).livepause(true);}});$this.find("input.vsbar_stop").click(function(){$fasttime=0;clearInterval($fastinterval);if(confirm("您确定要结束直播吗？结束后所有观众将不能继续收到直播信息！")){$this.removeAttr("live liveid");$arguments.live=="";vschess.livepause[$chessid]=true;$this.find("input.vsbar_play,input.vsbar_stop").hide();$this.find("input.vsbar_ctrl,input.vsbar_time").show();vschess.senddom[$chessid](true);}});$this.find("input.vsbar_next").mouseup(function(){$fasttime=0;clearInterval($fastinterval);if($arguments.live!="view"||vschess.livepause[$chessid]){var $buttonenabled=$(this).attr("disabled")!="disabled";$this.find(":animated").stop().hide();vschess.api.id($chessid)
...
else{vschess.sound.move();}}}}).mousedown(function(){vschess.api.id($chessid);$fasttime=0;clearInterval($fastinterval);$fastinterval=setInterval(function(){if($fasttime<10){++$fasttime;}
else{vschess.api.step(vschess.api.step()+1);if(vschess.api.step()==vschess.api.allstep()-1){$fasttime=0;clearInterval($fastinterval);}}},50);}).mouseout(function(){$fasttime=0;clearInterval($fastinterval);});$this.find("input.vsbar_next10").click(function(){$fasttime=0;clearInterval($fastinterval);if($arguments.live!="view"||vschess.livepause[$chessid]){$this.find(":animated").stop().hide();vschess.api.id($chessid).play(0).step(vschess.api.id($chessid).step()+10);}});$this.find("input.vsbar_last").click(function(){$fasttime=0;clearInterval($fastinterval);if($arguments.live!="view"||vschess.livepause[$chessid]){$this.find(":animated").stop().hide();vschess.api.id($chessid).play(0).step($jumian_each.length-1);}});$this.find("input.vsbar_time").click(function(){$this.find("ul.vsbar_funclist,ul.vsbar_savelist,ul.vsbar_pstnlist,ul.vsbar_bloglist").hide();$this.find("ul.vsbar_timelist").css("top",419-$this.find("ul.vsbar_timelist").outerHeight()).toggle();if(!IE){vschess.clip[$chessid].hide();}});$this.find("input.vsbar_func").click(function(){$this.find("ul.vsbar_timelist").hide();$this.find("ul.vsbar_funclist li,ul.vsbar_savelist li,ul.vsbar_pstnlist li,ul.vsbar_bloglist li").removeClass("hover");$this.find("ul.vsbar_funclist").css("top",419-$this.find("ul.vsbar_funclist").outerHeight()).toggle();if(!IE){if($this.find("ul.vsbar_funclist:visible").length){vschess.clip[$chessid].show();}
...
else{vschess.api.id($chessid).checkmove(0);}});if(IE){$this.find("li.vsbar_copy").click(function(){$this.find("ul.vsbar_funclist").hide();if(vschess.turn[$chessid]>1){window.clipboardData.setData("Text",vschess.turnfen(vschess.api.id($chessid).currentfen()));}
...
$("#vschess_copy_"+$chessid).mouseover(function(){vschess.clip[$chessid].reposition();});$this.find("div.vschess_bar li").click(function(){vschess.clip[$chessid].hide();});}})();vschess.api.id($chessid).format("chinese");if(vschess.server){if($arguments.live=="play"){$this.attr("live",$arguments.live).attr("liveid",$arguments.id);$.get(vschess.server+"action=live&id="+$arguments.id+"&mode=getdom",{random:Math.random()},function($str){if($str==""){$str="<n version=\"2\" create-time=\"*\" win=\"*\" m=\"rnbakabnr/9/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/9/RNBAKABNR w - - 0 1\"></n>";}
...
return vschess.api;}
else{return vschess.animate[vschess.api.boardid];}};vschess.api.tips=function(){$value=arguments[0];if($value||$value===0){if($value==1){vschess.tips[vschess.api.boardid]=1;vschess.api.thisdom.find("input.vschess_config_tips").attr("checked","checked");}
...
return vschess.api;};vschess.api.toString=function(){var $str="";$str+="棋盘编号："+vschess.api.boardid+"\n";$str+="初始FEN："+vschess.api.beginfen()+"\n";$str+="当前FEN："+vschess.api.currentfen()+"\n";$str+="当前局面号："+vschess.api.step()+"\n";$str+="总计局面数："+vschess.api.allstep()+"\n";$str+="播放状态："+vschess.api.play()+"\n";$str+="翻转状态："+vschess.api.turn()+"\n";return $str;};if(typeof window.vschess=="undefined"){window.vschess=vschess;$.fn.vschess=function(){if(typeof arguments[0]!="undefined"){var $args=arguments[0];}
